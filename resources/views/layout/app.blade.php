                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                            ...
                            <span class="text-xl font-bold">HealthCalc</span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="ml-3 relative">
                        <div>
                            <button type="button" class="flex text-sm rounded-full focus:outline-none">
                                <img class="h-8 w-8 rounded-full" src="https://via.placeholder.com/150" alt="User profile">
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center gap-2">
                        ...
                        <span class="text-lg font-bold text-green-500">HealthCalc</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:grid-cols-4">
                    <div>
                        <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Tentang Kami</h3>
                    </div>
                    <div>
                        <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Kebijakan Privasi</h3>
                    </div>
                    <div>
                        <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Syarat & Ketentuan</h3>
                    </div>
                    <div>
            ...
            <div class="mt-8 border-t border-gray-200 pt-4 md:flex md:items-center md:justify-between">
                <p class="text-sm text-gray-500">&copy; 2025 HealthCalc. All rights reserved.</p>
