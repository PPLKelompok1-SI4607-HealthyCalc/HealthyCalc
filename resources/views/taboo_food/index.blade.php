                        ...
                        @foreach ($tabooFoods as $tabooFood)
                            <div class="col-12 mb-2 search-item" data-food-name="{{ strtolower($tabooFood->food_name) }}"
                                ...
                                <div class="d-flex justify-content-start align-items-center p-0 ">
                                    ...
                                    <div class="p-2">
                                        <p class="m-0 py-1 px-2 bg-danger text-white rounded-2 m-0">
                                            {{ $tabooFood->taboo }}
                                        </p>
                                    </div>
                                    <div class="ms-auto">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="{{ route('taboo-foods.update', $tabooFood->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="taboo" class="col-form-label">Kategori
                                                                    Pantangan:</label>
                                                                <select class="form-select" name="taboo" required>
                                                                    <option disabled selected>Pilih Kategori</option>
                                                                    <option value="alergi"
                                                                        {{ $tabooFood->taboo == 'alergi' ? 'selected' : '' }}>
                                                                        Alergi</option>
                                                                    <option value="kolesterol"
                                                                        {{ $tabooFood->taboo == 'kolesterol' ? 'selected' : '' }}>
                                                                        Kolesterol</option>
                                                                    <option value="diabetes"
                                                                        {{ $tabooFood->taboo == 'diabetes' ? 'selected' : '' }}>
                                                                        Diabetes</option>
                                                                    <option value="diet"
                                                                        {{ $tabooFood->taboo == 'diet' ? 'selected' : '' }}>
                                                                        Diet</option>
                                                                    <option value="gula"
                                                                        {{ $tabooFood->taboo == 'gula' ? 'selected' : '' }}>
                                                                        Gula</option>
                                                                    <option value="garam"
                                                                        {{ $tabooFood->taboo == 'garam' ? 'selected' : '' }}>
                                                                        Garam</option>
                                                                    <option value="lemak"
                                                                        {{ $tabooFood->taboo == 'lemak' ? 'selected' : '' }}>
                                                                        Lemak</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
