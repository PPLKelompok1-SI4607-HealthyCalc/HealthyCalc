                            ...
                            <div class="d-flex justify-content-start align-items-center p-0">
                                ...
                                <div class="ms-auto d-flex gap-2">
                                    ...
                                    <div class="modal fade" id="editTabooFoodModal-{{ $tabooFood->id }}" tabindex="-1"
                                        aria-labelledby="editTabooFoodModalLabel-{{ $tabooFood->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form action="{{ route('taboo-foods.update', $tabooFood->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="editTabooFoodModalLabel-{{ $tabooFood->id }}">
