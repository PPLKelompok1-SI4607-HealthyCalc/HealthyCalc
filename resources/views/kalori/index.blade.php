...
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold text-center mb-4">Hitung Kalori</h2>
    ...
    <form action="{{ route('kalori.hitung') }}" method="POST">
        ...
        <button type="submit" class="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Hitung Kalori</button>
    </form>
</div>
@endsection