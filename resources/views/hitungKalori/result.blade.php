...
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="mt-6 flex justify-between">
        <a href="{{ route('dashboard') }}" class="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 text-center">
            Kembali ke Dashboard
        </a>
        <a href="{{ route('kalori.edit') }}" class="w-full bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-600 text-center ml-4">
            Edit Perhitungan
        </a>
    </div>
</div>
