        ...
        <div class="row">
            <div class="col-12 col-lg-8 ">
                ...
                <div class="row mb-2">
                    ...
                    @foreach ($communities_trending as $community_trending)
                            ...
                            <div class="d-flex">
                                <div class="p-2 flex-grow-1">
                                    <input type="text" class="form-control"  id="searchInput"
                                        placeholder="Cari Aktivitas" aria-label="Search" aria-describedby="basic-addon1">
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <form action=" {{ route('communities.store') }}" method="POST">
                                                ...
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="community-title">Buat Postingan Baru
                                                    </h1>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <div class="card w-100 h-100 border-0 shadow-sm p-2" style="width: 18rem;">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <span class="border-start border-5 border-success">
                                        <p class="fs-5 fw-bold">
                                            Webinar: Nutrisi untuk Imunitas
                                        </p>
                        ...
                        <div class="card w-100 h-100 border-0 shadow-sm p-2" style="width: 18rem;">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="d-flex justify-content-start p-0">
                                        <div class=" d-flex align-items-center">
                                            <img src="img/apple.svg" class="img-fluid pe-2" style="max-width: 40px;"
                                                alt="">
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="m-0">
                                ...
                                <div class="row mb-3">
                                    <div class="d-flex justify-content-start p-0">
                                        <div class=" d-flex align-items-center">
                                            <img src="img/water.svg" class="img-fluid pe-2" style="max-width: 40px;"
                                                alt="">
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="m-0">
                                                    Minum 8 gelas air putih setiap hari </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="d-flex justify-content-start p-0">
                                        <div class=" d-flex align-items-center">
                                            <img src="img/moon.svg" class="img-fluid pe-2" style="max-width: 40px;"
                                                alt="">
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="m-0">
                                                    Tidur 7-8 jam setiap malam </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
