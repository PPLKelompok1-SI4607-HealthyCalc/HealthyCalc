                    ...
                    @forelse ($recipes as $recipe)
                        <div class="col search-item">
                            <a href="{{ route('recipes.show', $recipe->id) }}" class="text-decoration-none text-dark">
                                <div class="card mb-3 " onmouseover="this.classList.remove('shadow-sm'); this.classList.add('shadow');"
                                    onmouseout="this.classList.remove('shadow'); this.classList.add('shadow-sm');">
                                    <img src="{{ asset('img/' . ($recipe->image ?? 'makanan.jpeg')) }}" class="card-img-top"
                                        alt="Gambar resep" style="max-height: 200px; object-fit: cover;">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button class="btn btn-link text-dark p-0 m-0" type="button"
                                                data-bs-toggle="modal" data-bs-target="#editrecipeModal-{{ $recipe->id }}">
